...
buildCart = () => {
    return `
    <h1> Shopping Cart </h1>
    <p> Carets: ${newRingOrder.carets}</p>
    <p> Metal: ${newRingOrder.metal}</p>
    <p> Price: ${newRingOrder.price}</p>
    <p> Style: ${newRingOrder.style}</p>
    `
}

document.querySelector("#shopping-cart").innerHTML = buildCart()